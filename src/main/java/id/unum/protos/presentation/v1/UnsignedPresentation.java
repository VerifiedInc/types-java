...
// Source: presentation.v1.UnsignedPresentation in presentation.proto
 ...
 */
public final class UnsignedPresentation extends Message<UnsignedPresentation, UnsignedPresentation.Builder> {
  public static final ProtoAdapter<UnsignedPresentation> ADAPTER = new ProtoAdapter_UnsignedPresentation();
  ...
  public UnsignedPresentation(List<String> context, List<String> type,
      String presentation_request_id, String verifierDid, List<Credential> verifiable_credential) {
    this(context, type, presentation_request_id, verifierDid, verifiable_credential, ByteString.EMPTY);
  }
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof UnsignedPresentation)) return false;
    UnsignedPresentation o = (UnsignedPresentation) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "UnsignedPresentation{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<UnsignedPresentation, Builder> {
    ...
    @Override
    public UnsignedPresentation build() {
      return new UnsignedPresentation(context, type, presentation_request_id, verifierDid, verifiable_credential, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_UnsignedPresentation extends ProtoAdapter<UnsignedPresentation> {
    public ProtoAdapter_UnsignedPresentation() {
      super(FieldEncoding.LENGTH_DELIMITED, UnsignedPresentation.class, "type.googleapis.com/presentation.v1.UnsignedPresentation", Syntax.PROTO_3, null);
    }

    @Override
    public int encodedSize(UnsignedPresentation value) {
      int result = 0;
    ...
    @Override
    public void encode(ProtoWriter writer, UnsignedPresentation value) throws IOException {
    ...
    @Override
    public void encode(ReverseProtoWriter writer, UnsignedPresentation value) throws IOException {
      writer.writeBytes(value.unknownFields());
      Credential.ADAPTER.asRepeated().encodeWithTag(writer, 5, value.verifiable_credential);
      if (!Objects.equals(value.verifierDid, "")) ProtoAdapter.STRING.encodeWithTag(writer, 4, value.verifierDid);
      if (!Objects.equals(value.presentation_request_id, "")) ProtoAdapter.STRING.encodeWithTag(writer, 3, value.presentation_request_id);
    ...
    @Override
    public UnsignedPresentation decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public UnsignedPresentation redact(UnsignedPresentation value) {
